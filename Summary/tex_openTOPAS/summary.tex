...
\DeclareRobustCommand\SUTname{TOPAS-nBio v4.1.0 (OpenTOPAS v4.2.1, Geant4-11.3.2)}
\DeclareRobustCommand\benchmarkname{TOPAS-nBio v4.0 (OpenTOPAS v4.0, Geant4-11.1.3)}
...
This document depicts the results for 13 separate regression tests, comparing TOPAS-nBio v4.1.0 to TOPAS-nBio v4.0.
