...
\DeclareRobustCommand\SUTname{TOPAS-nBio v3.0 (OpenTOPAS v4.0)}
\DeclareRobustCommand\benchmarkname{TOPAS-nBio v2.0 (TOPAS v3.9)}


\title{\SUTname}
\subtitle{Regression testing (cf.\ \benchmarkname)\thanks{Given the substantial changes to the code (see release notes), certain regression tests in OpenTOPAS-nBio are not able to be performed in TOPAS-nBio. In these cases OpenTOPAS-nBio is simply compared against itself.}}
