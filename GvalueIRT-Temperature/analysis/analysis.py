...
def plot_results(sut_dir, ref_dir, args):
    ...
    ax3.errorbar(sut_G[-1]["H^0"][:,0],    sut_G[-1]["H^0"][:,1],    yerr=sut_G[-1]["H^0"][:,2],     color="r", linewidth=2)
    ax4.errorbar(sut_G[-1]["H_2^0"][:,0],  sut_G[-1]["H_2^0"][:,1],  yerr=sut_G[-1]["H_2^0"][:,2],   color="r", linewidth=2)
    ax5.errorbar(sut_G[-1]["H2O2^0"][:,0], sut_G[-1]["H2O2^0"][:,1], yerr=sut_G[-1]["H2O2^0"][:,2],  color="r", linewidth=2)
    ax6.errorbar(sut_G[-1]["H3O^1"][:,0],  sut_G[-1]["H3O^1"][:,1],  yerr=sut_G[-1]["H3O^1"][:,2],   color="r", linewidth=2)
    ax7.errorbar(sut_G[-1]["OH^-1"][:,0],  sut_G[-1]["OH^-1"][:,1],  yerr=sut_G[-1]["OH^-1"][:,2],   color="r", linewidth=2)
    ...
    ax3.errorbar(ref_G[-1]["H^0"][:,0],    ref_G[-1]["H^0"][:,1],    yerr=ref_G[-1]["H^0"][:,2],     color="g", linewidth=2)
    ax4.errorbar(ref_G[-1]["H_2^0"][:,0],  ref_G[-1]["H_2^0"][:,1],  yerr=ref_G[-1]["H_2^0"][:,2],   color="g", linewidth=2)
    ax5.errorbar(ref_G[-1]["H2O2^0"][:,0], ref_G[-1]["H2O2^0"][:,1], yerr=ref_G[-1]["H2O2^0"][:,2],  color="g", linewidth=2)
    ax6.errorbar(ref_G[-1]["H3O^1"][:,0],  ref_G[-1]["H3O^1"][:,1],  yerr=ref_G[-1]["H3O^1"][:,2],   color="g", linewidth=2)
    ax7.errorbar(ref_G[-1]["OH^-1"][:,0],  ref_G[-1]["OH^-1"][:,1],  yerr=ref_G[-1]["OH^-1"][:,2],   color="g", linewidth=2)
